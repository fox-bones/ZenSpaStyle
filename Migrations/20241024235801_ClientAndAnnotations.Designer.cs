...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241024235801_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 24, 19, 58, 1, 644, DateTimeKind.Local).AddTicks(8047),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 10, 24, 19, 58, 1, 644, DateTimeKind.Local).AddTicks(8093),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 24, 19, 58, 1, 644, DateTimeKind.Local).AddTicks(8096),
                            ServicesID = 5
                        });
                });
