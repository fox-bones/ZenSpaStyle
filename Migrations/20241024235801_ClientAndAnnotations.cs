    ...
    public partial class ClientAndAnnotations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 10, 24, 19, 58, 1, 644, DateTimeKind.Local).AddTicks(8047), 1 },
                    { 2, 2, new DateTime(2024, 10, 24, 19, 58, 1, 644, DateTimeKind.Local).AddTicks(8093), 7 },
                    { 3, 1, new DateTime(2024, 10, 24, 19, 58, 1, 644, DateTimeKind.Local).AddTicks(8096), 5 }
                });
